...
export const PATH_TO_TEMPLATES = `${PATH_TO_PACKAGE}${PATH_SEPARATOR}templates`;
export const TEST_RESULT_TEMPLATE = 'testResult';
export const TEST_SUITE_TEMPLATE = 'testSuite';
export const REPORT_TEMPLATE = 'report';
export const TEST_DIRECTORY = 'test';
export const IMAGE_TEMPLATE = 'base64Image';
